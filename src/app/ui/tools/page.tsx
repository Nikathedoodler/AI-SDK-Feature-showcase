...
export default function ToolsChatPage() {
  ...
  return (
    <FeatureLayout
      ...
      description="Execute functions and tools within conversations. This demonstrates AI's ability to call external functions and integrate with various services and APIs."
      icon="⚙️"
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 shadow-lg overflow-hidden h-[600px] sm:h-[700px] lg:h-[800px] flex flex-col">
          ...
          <div className="border-b border-slate-200 dark:border-slate-700 p-4 bg-slate-50 dark:bg-slate-900">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-sm text-slate-600 dark:text-slate-400 ml-4">Function Calling Assistant</span>
            </div>
          </div>
          ...
          <div className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-4">
            ...
            {messages.length === 0 && (
              <div className="text-center py-8">
                ...
                <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-2">Function Calling Ready</h3>
                <p className="text-slate-600 dark:text-slate-400">I can execute functions and tools to help you with various tasks!</p>
              </div>
            )}
              ...
              <div className="flex justify-start">
                <div className="bg-slate-100 dark:bg-slate-700 rounded-2xl px-4 py-3">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm text-slate-600 dark:text-slate-400">Processing with functions...</span>
                  </div>
                </div>
              </div>
            )}
          ...
          <div className="border-t border-slate-200 dark:border-slate-700 p-3 sm:p-4 bg-slate-50 dark:bg-slate-900">
            <form onSubmit={handleSubmit} className="flex gap-2 sm:gap-3">
              <input
                ...
                placeholder="Ask me to use functions or tools..."
                value={input}
        ...
        <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-xl p-4 sm:p-6">
          ...
          <ul className="text-sm text-blue-800 dark:text-blue-200 space-y-2">
            <li>• Function calling and tool execution</li>
            <li>• Real-time function invocation with visual feedback</li>
            <li>• Structured tool results and error handling</li>
            <li>• Integration with external APIs and services</li>
            <li>• Dynamic function parameter handling</li>
          </ul>
        </div>
      </div>
    </FeatureLayout>
