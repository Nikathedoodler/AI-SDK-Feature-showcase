...
export default function MultipleToolsChatPage() {
  ...
  const examplePrompts = [
    ...
    "Calculate 25 * 17 and get a random number",
    "Create a todo list and check the time",
    "Get weather info and generate a random color",
  ...
  return (
    <FeatureLayout
      ...
      description="Coordinate multiple tools and functions in a single conversation. This demonstrates AI's ability to orchestrate complex workflows using multiple tools simultaneously."
      icon="🔗"
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 shadow-lg overflow-hidden h-[600px] sm:h-[700px] lg:h-[800px] flex flex-col">
          ...
          <div className="border-b border-slate-200 dark:border-slate-700 p-4 bg-slate-50 dark:bg-slate-900">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-sm text-slate-600 dark:text-slate-400 ml-4">Tool Orchestration Assistant</span>
            </div>
          </div>
          ...
          <div className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-4">
            ...
            {messages.length === 0 && (
              <div className="text-center py-8">
                ...
                <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-2">Tool Orchestration Ready</h3>
                <p className="text-slate-600 dark:text-slate-400">I can coordinate multiple tools and functions to complete complex tasks!</p>
              </div>
            )}
              ...
              <div className="flex justify-start">
                <div className="bg-slate-100 dark:bg-slate-700 rounded-2xl px-4 py-3">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm text-slate-600 dark:text-slate-400">Orchestrating multiple tools...</span>
                  </div>
                </div>
              </div>
            )}
          ...
          <div className="border-t border-slate-200 dark:border-slate-700 p-3 sm:p-4 bg-slate-50 dark:bg-slate-900">
            <form onSubmit={handleSubmit} className="flex gap-2 sm:gap-3">
              <input
                ...
                placeholder="Ask me to use multiple tools together..."
                value={input}
        ...
        <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-xl p-4 sm:p-6">
          ...
          <ul className="text-sm text-blue-800 dark:text-blue-200 space-y-2">
            <li>• Multiple tool coordination and orchestration</li>
            <li>• Sequential and parallel tool execution</li>
            <li>• Complex workflow management</li>
            <li>• Tool result aggregation and processing</li>
            <li>• Advanced function calling patterns</li>
          </ul>
        </div>
      </div>
    </FeatureLayout>
