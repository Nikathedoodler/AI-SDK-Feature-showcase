            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                <Link href="/" className="group">
                  <h1 className="text-2xl font-bold text-slate-900 dark:text-white mb-1">AI SDK Showcase</h1>
                  <p className="text-sm text-slate-600 dark:text-slate-400">All Features</p>
                </Link>
                <Link 
                  href="/"
